    ...
    <>
      ...
      >
        <div className="xl:inline-block hidden">
          <div className={`flex  justify-center items-center`}>
            <div className="flex flex-col justify-center items-center pl-4">
              ...
              <div
                className={`w-[2px] min-h-[570px] bg-black ${
        ...
        <div className="xl:pl-8">
          <h4 className="text-lg font-bold xl:text-start text-center">
            HELLO,
            <span className="text-secondary"> MY NAME IS</span>
          </h4>
          <h1
            className="sm:text-[81px] font-jost 
          ...
          <h4
            className={`min-h-[50px] font-bold sm:text-4xl text-[23px] font-caveat mb-14 xl:text-start text-center`}
          >
            <TypeAnimation
              preRenderFirstString={false}
              sequence={[`I am a`, 1000]}
              wrapper="span"
              speed={5}
          ...
          <div className="xl:block hidden">
            <div className="">
              <p className="text-lg">
                I'm from Feni, Bangladesh, with strong expertise in React and
                the Node.js ecosystem. I enjoy having unique and meaningful
                conversations with you!
              </p>
              <ul className="flex justify-start mt-8 mb-16 gap-8">
                <li className="group">
                  <a
                    href="https://www.facebook.com/mx.pranto.9/"
                    target="_blank"
                  >
                    <AiFillFacebook
                      size={30}
                ...
                <li className="group">
                  <a
                    href="https://www.instagram.com/a.a.pranto/"
                    target="_blank"
                  >
                    <AiFillInstagram
                      size={30}
