...
const Navpage = ({ navbutton }) => {
    return (
        <>
            <div className={`sm:min-h-[700px] min-h-[500px]  bg-white absolute top-0 right-0
        ...
        rounded-s-xl flex justify-between`}
            >
                    ...
                    <div className='flex flex-col justify-center items-center sm:pr-10 pr-2'>
                        ...
                        <div className='w-[2px] min-h-[350px] sm:min-h-[550px] bg-black duration-300'></div>
                        <div className='w-7 h-7 bg-white rounded-full border-[2px] border-black'></div>
                    </div>
                    <ul className={`flex flex-col sm:gap-24 gap-16 ${navbutton ? 'block' : 'hidden'}`}>
                        <Link to='home' smooth={true} duration={500} className='sm:text-2xl text-xl font-bold flex gap-2 justify-start items-center group'>
                            <AiOutlineHome size={25} className='group-hover:text-orange-700 duration-200 cursor-pointer' />
                            <h2 className='group-hover:text-orange-700 duration-200 cursor-pointer'>HOME</h2>
                        </Link>
                        <Link to='about' smooth={true} duration={500} className='sm:text-2xl text-xl font-bold flex gap-2 justify-start items-center group'>
                            <AiOutlineInfoCircle size={25} className='group-hover:text-orange-700 duration-200 cursor-pointer' />
                            <h2 className='group-hover:text-orange-700 duration-200 cursor-pointer'>ABOUT</h2>
                        </Link>
                        <Link to='/' smooth={true} duration={500} className='sm:text-2xl text-xl font-bold flex gap-2 justify-start items-center group'>
                            <ImBlog size={25} className='group-hover:text-orange-700 duration-200 cursor-pointer' />
                            <h2 className='group-hover:text-orange-700 duration-200 cursor-pointer'>BLOG</h2>
                        </Link>
                        <Link to='portfolio' smooth={true} duration={500} className='sm:text-2xl text-xl font-bold flex gap-2 justify-start items-center group'>
                            <BsGrid1X2 size={25} className='group-hover:text-orange-700 duration-200 cursor-pointer' />
                            <h2 className='group-hover:text-orange-700 duration-200 cursor-pointer'>PORTFOLIO</h2>
                        </Link>
                        <Link to='contact' smooth={true} duration={500} className='sm:text-2xl text-xl font-bold flex gap-2 justify-start items-center group'>
                            <RiContactsBookLine size={25} className='group-hover:text-orange-700 duration-200 cursor-pointer' />
                            <h2 className='group-hover:text-orange-700 duration-200 cursor-pointer'>CONTACT</h2>
                        </Link>
                    </ul>
                </div>
            </div>
