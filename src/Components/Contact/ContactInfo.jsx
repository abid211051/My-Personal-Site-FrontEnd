    ...
    <>
      <div className='sm:w-[80%] w-full h-full flex flex-col gap-14'>
          <div className='flex sm:flex-row flex-col items-center'>
            <div className={`w-14 h-14 rounded-full border-[2px] shado flex justify-center items-center ${toggle ? 'border-gray-400': 'border-black'} `}>
              <BsMap size={20} />
            </div>
            <div className={`sm:w-10 sm:h-[2px] w-[2px] h-10 ${toggle ? 'bg-slate-400':'bg-black'}`}></div>
