  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="backdrop-blur-2xl  duration-200 
                absolute top-0 -left-[100%] group-hover:left-0 gap-5
                w-full h-full text-green-600 flex justify-center items-center flex-col"
        >
          <h3 className="sm:text-2xl text-xl">{item.title}</h3>
          <a href={item.path} target="_blank">
            <button className="p-2 font-caveat sm:text-2xl text-xl border-[2px] rounded-lg border-indigo-600">
              Show Live
            </button>
          </a>
        </div>
