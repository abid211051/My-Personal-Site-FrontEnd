...
const ResumeBlock = ({ item, i }) => {
  ...
  return (
    <>
      <div
        onClick={handlechage}
        className="flex flex-col p-2 w-full cursor-pointer"
      >
        ...
        >
          <div className="my-4 px-2 overflow-hidden">
        ...
        <div className="flex relative justify-center items-center">
          <div
            className={`w-full h-[2px] ${toggle ? "bg-gray-400" : "bg-black"}`}
          ></div>
          <div className="flex flex-col items-center justify-start relative">
            {i !== 0 && (
              <div
                className={`w-[2px] ${
                  change ? "sm:h-[18.5rem] h-[24.8rem]" : "h-[2.9rem]"
                } 
