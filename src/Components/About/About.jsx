...
const About = () => {
  ...
  return (
    <>
      <div className='relative pt-48 px-3 flex flex-col justify-center items-center' id='about'>
        <h1 className='sm:text-7xl text-4xl font-bold font-jost text-center animate-text bg-gradient-to-r from-cyan-700 via-rose-600
      to-teal-500 bg-clip-text text-transparent'>ABOUT</h1>
      <h3 className='font-caveat text-3xl font-semibold'>Explore <span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-600'>Me</span></h3>
      ...
      to-teal-500 bg-clip-text text-transparent'>
          ...
          <div className='w-40 h-1 bg-orange-500'></div>
          <h1 className='opacity-5 font-caveat lg:text-[400px] 
                md:text-[300px] sm:text-[250px] text-[40vw] 
                font-extrabold absolute text-center'>
            Resume
          </h1>
        </div>
        <div className='grid lg:grid-cols-2 sm:px-4 sm:gap-0 gap-12 relative' id='skill'>
          <Education />
          <Experience />
        </div>
      </div>
